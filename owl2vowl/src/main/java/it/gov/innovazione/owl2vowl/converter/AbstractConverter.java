...
import it.gov.innovazione.owl2vowl.export.types.JsonGenerator;
import it.gov.innovazione.owl2vowl.model.data.VowlData;
import it.gov.innovazione.owl2vowl.model.entities.AbstractEntity;
import it.gov.innovazione.owl2vowl.parser.owlapi.EntityCreationVisitor;
import it.gov.innovazione.owl2vowl.parser.owlapi.IndividualsVisitor;
import it.gov.innovazione.owl2vowl.parser.vowl.AnnotationParser;
import it.gov.innovazione.owl2vowl.parser.vowl.BaseIriCollector;
import it.gov.innovazione.owl2vowl.parser.vowl.EquivalentSorter;
import it.gov.innovazione.owl2vowl.parser.vowl.ImportedChecker;
import it.gov.innovazione.owl2vowl.parser.vowl.OntologyInformationParser;
import it.gov.innovazione.owl2vowl.parser.vowl.TypeSetter;
import it.gov.innovazione.owl2vowl.parser.vowl.classes.GenericClassAxiomVisitor;
import it.gov.innovazione.owl2vowl.parser.vowl.classes.HasKeyAxiomParser;
import it.gov.innovazione.owl2vowl.parser.vowl.classes.OwlClassAxiomVisitor;
import it.gov.innovazione.owl2vowl.parser.vowl.property.DataPropertyVisitor;
import it.gov.innovazione.owl2vowl.parser.vowl.property.DomainRangeFiller;
import it.gov.innovazione.owl2vowl.parser.vowl.property.ObjectPropertyVisitor;
import it.gov.innovazione.owl2vowl.parser.vowl.property.VowlSubclassPropertyGenerator;
